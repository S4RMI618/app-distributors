                    ...
                    <form action="{{ route('orders.update', $order->id) }}" method="POST">
                            ...
                            <div id="selected_products_list" class="block mt-1 w-full rounded-md">
                                @foreach ($order->products as $product)
                                    <div
                                        ...
                                        <span
                                            class="product-name font-medium w-full text-center text-1xl bg-gray-200 rounded-md p-1">{{ $product->name }}
                                            - {{ $product->code }}</span>
                                        <div
                                            class="flex w-full items-center justify-between md:justify-around gap-4 py-2">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="observations" name="observations" class="block mt-1 w-full rounded-md p-1 px-2 md:p-4" rows="3"
                                placeholder="Escribe aquí las observaciones...">{{ $order->observations }}</textarea>
